...
curl -o data/navigo_all_pointcalls.csv "http://sandbox.robindemourat.com/portic-data-v10/pointcalls.csv"
...
curl -o data/navigo_all_flows.csv "http://sandbox.robindemourat.com/portic-data-v10/flows.csv"

echo "Download data : fetching latest navigo cargo data"

curl -o data/navigo_cargo.csv "http://sandbox.robindemourat.com/portic-data-v10/cargo.csv"
