...
import VisualizationContainer from '../VisualizationContainer/VisualizationContainer.js';
          ...
          <div className="lightbox-contents-container">
            <div className="lightbox-contents">
              ...
              <div className="visualization-wrapper" onClick={handleWrapperClick}>
                <VisualizationContainer lang={lang} atlasMode activeVisualization={visualization} />
              </div>
            </div>
          </div>
          : null
