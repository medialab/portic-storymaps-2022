      ...
      }
      {
        +step >= 3 ?
          <g className="map-container"
            transform={`translate(${-imageSide / 2}, ${-imageSide * .75})`}
          >
            <image
            ...
            <G transform={`scale(${scaleSVGObjects}) translate(0, ${imageSide * scaleSVGObjects * .1})`}>
              <path
 ...
 */}
        <animated.stop offset={'0%'} stopColor={'red'} />
        <animated.stop offset={'5%'} stopColor={'red'} />
